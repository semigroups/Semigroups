...
# constructions: FreeSemilattice: partial perm semigroup
S := FreeSemilattice(IsPartialPermSemigroup, 1);
<trivial partial perm group of rank 0 with 1 generator>
S := FreeSemilattice(IsPartialPermSemigroup, 2);
<partial perm semigroup of size 3, rank 2 with 2 generators>
S := FreeSemilattice(IsPartialPermSemigroup, 5);
<partial perm semigroup of size 31, rank 5 with 5 generators>
S := FreeSemilattice(IsPartialPermSemigroup, 11);
<partial perm semigroup of size 2047, rank 11 with 11 generators>

# constructions: FreeSemilattice: bipartition semigroup
S := FreeSemilattice(IsBipartitionSemigroup, 1);
<trivial bipartition group of degree 2 with 1 generator>
S := FreeSemilattice(IsBipartitionSemigroup, 2);
<bipartition semigroup of size 3, degree 3 with 2 generators>
S := FreeSemilattice(IsBipartitionSemigroup, 5);
<bipartition semigroup of size 31, degree 6 with 5 generators>
S := FreeSemilattice(IsBipartitionSemigroup, 11);
<bipartition semigroup of size 2047, degree 12 with 11 generators>

# constructions: FreeSemilattice: PBR semigroup
S := FreeSemilattice(IsPBRSemigroup, 1);
<trivial pbr group of degree 2 with 1 generator>
S := FreeSemilattice(IsPBRSemigroup, 2);
<pbr semigroup of size 3, degree 3 with 2 generators>
S := FreeSemilattice(IsPBRSemigroup, 5);
<pbr semigroup of size 31, degree 6 with 5 generators>
S := FreeSemilattice(IsPBRSemigroup, 11);
<pbr semigroup of size 2047, degree 12 with 11 generators>
S := FreeSemilattice(IsBooleanMatSemigroup, 1);

# constructions: FreeSemilattice: Boolean matrix semigroup
<trivial group of 2x2 boolean matrices with 1 generator>
S := FreeSemilattice(IsBooleanMatSemigroup, 2);
<semigroup of size 3, 3x3 boolean matrices with 2 generators>
S := FreeSemilattice(IsBooleanMatSemigroup, 5);
<semigroup of size 31, 6x6 boolean matrices with 5 generators>
S := FreeSemilattice(IsBooleanMatSemigroup, 11);
<semigroup of size 2047, 12x12 boolean matrices with 11 generators\
>

# constructions: FreeSemilattice: NTP matrix semigroup
S := FreeSemilattice(IsNTPMatrixSemigroup, 1);
<trivial group of 2x2 ntp matrices with 1 generator>
S := FreeSemilattice(IsNTPMatrixSemigroup, 2);
<semigroup of size 3, 3x3 ntp matrices with 2 generators>
S := FreeSemilattice(IsNTPMatrixSemigroup, 5);
<semigroup of size 31, 6x6 ntp matrices with 5 generators>
S := FreeSemilattice(IsNTPMatrixSemigroup, 11);
<semigroup of size 2047, 12x12 ntp matrices with 11 generators>

# constructions: FreeSemilattice: max-plus matrix semigroup
S := FreeSemilattice(IsMaxPlusMatrixSemigroup, 1);
<trivial group of 2x2 max-plus matrices with 1 generator>
S := FreeSemilattice(IsMaxPlusMatrixSemigroup, 2);
<semigroup of size 3, 3x3 max-plus matrices with 2 generators>
S := FreeSemilattice(IsMaxPlusMatrixSemigroup, 5);
<semigroup of size 31, 6x6 max-plus matrices with 5 generators>
S := FreeSemilattice(IsMaxPlusMatrixSemigroup, 11);
<semigroup of size 2047, 12x12 max-plus matrices with 11 generator\
s>

# constructions: FreeSemilattice: min-plus matrix semigroup
S := FreeSemilattice(IsMinPlusMatrixSemigroup, 1);
<trivial group of 2x2 min-plus matrices with 1 generator>
S := FreeSemilattice(IsMinPlusMatrixSemigroup, 2);
<semigroup of size 3, 3x3 min-plus matrices with 2 generators>
S := FreeSemilattice(IsMinPlusMatrixSemigroup, 5);
<semigroup of size 31, 6x6 min-plus matrices with 5 generators>
S := FreeSemilattice(IsMinPlusMatrixSemigroup, 11);
<semigroup of size 2047, 12x12 min-plus matrices with 11 generator\
s>

# constructions: FreeSemilattice: tropical max-plus matrix semigroup
S := FreeSemilattice(IsTropicalMaxPlusMatrixSemigroup, 1);
<trivial group of 2x2 tropical max-plus matrices with 1 generator>
S := FreeSemilattice(IsTropicalMaxPlusMatrixSemigroup, 2);
<semigroup of size 3, 3x3 tropical max-plus matrices with 2 genera\
tors>
S := FreeSemilattice(IsTropicalMaxPlusMatrixSemigroup, 5);
<semigroup of size 31, 6x6 tropical max-plus matrices with 5 gener\
ators>
S := FreeSemilattice(IsTropicalMaxPlusMatrixSemigroup, 11);
<semigroup of size 2047, 12x12 tropical max-plus matrices with 11 \
generators>

# constructions: FreeSemilattice: tropical min-plus matrix semigroup
S := FreeSemilattice(IsTropicalMinPlusMatrixSemigroup, 1);
<trivial group of 2x2 tropical min-plus matrices with 1 generator>
S := FreeSemilattice(IsTropicalMinPlusMatrixSemigroup, 2);
<semigroup of size 3, 3x3 tropical min-plus matrices with 2 genera\
tors>
S := FreeSemilattice(IsTropicalMinPlusMatrixSemigroup, 5);
<semigroup of size 31, 6x6 tropical min-plus matrices with 5 gener\
ators>
S := FreeSemilattice(IsTropicalMinPlusMatrixSemigroup, 11);
<semigroup of size 2047, 12x12 tropical min-plus matrices with 11 \
generators>

# constructions: FreeSemilattice: projective max-plus matrix semigroup
S := FreeSemilattice(IsProjectiveMaxPlusMatrixSemigroup, 1);
<trivial group of 2x2 projective max-plus matrices with 1 generato\
r>
S := FreeSemilattice(IsProjectiveMaxPlusMatrixSemigroup, 2);
<semigroup of size 3, 3x3 projective max-plus matrices with 2 gene\
rators>
S := FreeSemilattice(IsProjectiveMaxPlusMatrixSemigroup, 5);
<semigroup of size 31, 6x6 projective max-plus matrices with 5 gen\
erators>
S := FreeSemilattice(IsProjectiveMaxPlusMatrixSemigroup, 11);
<semigroup of size 2047, 12x12 projective max-plus matrices with 1\
1 
 generators>

# constructions: FreeSemilattice: integer matrix semigroup
S := FreeSemilattice(IsIntegerMatrixSemigroup, 1);
<trivial group of 2x2 integer matrices with 1 generator>
S := FreeSemilattice(IsIntegerMatrixSemigroup, 2);
<semigroup of size 3, 3x3 integer matrices with 2 generators>
S := FreeSemilattice(IsIntegerMatrixSemigroup, 5);
<semigroup of size 31, 6x6 integer matrices with 5 generators>
S := FreeSemilattice(IsIntegerMatrixSemigroup, 11);
<semigroup of size 2047, 12x12 integer matrices with 11 generators\
>
