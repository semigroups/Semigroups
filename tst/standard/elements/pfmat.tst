...
#############################################################################
##
gap> START_TEST("Semigroups package: standard/elements/pfmat.tst");
gap> LoadPackage("semigroups", false);;

#
gap> SEMIGROUPS_StartTest();

# pfmat: Matrix, checker, 1/1
...
#E#
gap> STOP_TEST("Semigroups package: standard/elements/pfmat.tst");
