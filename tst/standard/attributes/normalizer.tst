...
Group([ (2,3), (1,2,3) ])
gap> SEMIGROUPS_DeterministicNormalizer(SymmetricGroup(3), S,
> rec(lambdastab := false));
Group([ (2,3), (1,2,3) ])
gap> SEMIGROUPS_DeterministicNormalizer(Group(()), S,
> rec(lambdastab := false));
Group(())
...
> rec(lambdastab := false));
Group([ (1,3,2), (1,3) ])
gap> SEMIGROUPS_NonDeterministicNormalizer(Group(()), S,
> rec(lambdastab := false));
Group(())
