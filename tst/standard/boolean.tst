...
# boolean: BooleanMat, for 0s and 1s, 2/6
gap> BooleanMat([[1, 0, 1], [0, 1, 0], [0, 1, 0]]);
<3x3 boolean matrix>

# boolean: BooleanMat, for blists in blist_rep, 3/6
gap> BooleanMat([[true, false, true], [false, true, false], 
> [false, true, false]]);
<3x3 boolean matrix>

# boolean: BooleanMat, for blists not in blist_rep, 4/6
gap> BooleanMat(List([1 .. 3], y -> List([1 .. 3], x -> x = x)));
<3x3 boolean matrix>

# boolean: BooleanMat, for successors, 5/6
gap> BooleanMat([[1], [3, 4], [2], [1]]);
<4x4 boolean matrix>

# boolean: BooleanMat, for successors, error, 6/6
