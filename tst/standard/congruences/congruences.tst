#############################################################################
##
#W  standard/congruences/congruences.tst
...
#############################################################################
##
gap> START_TEST("Semigroups package: standard/congruences/congruences.tst");
...
gap> pairs := [[Transformation([1,1,1,1,1]), Transformation([3,3,3,3,3])]];;
...
Error, Semigroups: LeftSemigroupCongruence: usage,
<pairs> should be a list of lists of size 2,
gap> LeftSemigroupCongruence(S, [Transformation([2,7]), Transformation([2,3])]);
Error, Semigroups: LeftSemigroupCongruence: usage,
each pair should contain elements from the semigroup <S>,
gap> S := FullTransformationSemigroup(6);;
...
Error, Semigroups: RightSemigroupCongruence: usage,
<pairs> should be a list of lists of size 2,
gap> RightSemigroupCongruence(S, [Transformation([2,7]), Transformation([2,3])]);
Error, Semigroups: RightSemigroupCongruence: usage,
each pair should contain elements from the semigroup <S>,
gap> S := FullTransformationSemigroup(6);;
...
gap> S := Semigroup(Transformation([1,4,3,4]), Transformation([2,3,4,2]));;
