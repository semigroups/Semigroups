...
# CanComputeGapFroidurePin for RZMS
gap> S := ReesZeroMatrixSemigroup(Group([()]), [[(), (), ()], [0, (), 0],
>  [(), 0, ()]]);;
gap> CanComputeGapFroidurePin(S);
true

# CanComputeGapFroidurePin for a quotient semigroup
gap> S := FullTransformationMonoid(4);;
gap> cong := SemigroupCongruence(S, [S.2, S.3]);;
gap> CanComputeGapFroidurePin(S / cong);
true
...
# CanComputeGapFroidurePin for a free band
gap> CanComputeGapFroidurePin(FreeBand(4));
true
gap> CanComputeGapFroidurePin(FreeBand(5));
true
...
# EnumeratorCanonical for CanComputeGapFroidurePin without generators
