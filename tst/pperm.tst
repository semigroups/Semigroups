...
#############################################################################
##
gap> START_TEST("Semigroups package: pperm.tst");
gap> display:=UserPreference("PartialPermDisplayLimit");;
gap> notation:=UserPreference("NotationForPartialPerms");;
...
gap> SetUserPreference("NotationForPartialPerm", notation);;
gap> SetInfoLevel(InfoWarning, InfoLevelInfoWarning);;

#
gap> STOP_TEST("Semigroups package: pperm.tst", 10000);
