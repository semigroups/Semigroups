...
#T# Factorization for a transformation semigroup 1
...
#T# Factorization for a transformation semigroup 2
...
#T# Factorization for a transformation semigroup 3
...
#T# Factorization for a transformation semigroup 4
gap> gens:=[ Transformation( [ 3, 4, 1, 2, 1 ] ),
>  Transformation( [ 4, 2, 1, 5, 5 ] ),
>  Transformation( [ 4, 2, 2, 2, 4 ] ) ];;
gap> s:=Semigroup(gens);;
...
#T# Factorization for a transformation semigroup 5
gap> gens:=[ Transformation( [ 1, 3, 2, 3 ] ),
> Transformation( [ 1, 4, 1, 2 ] ),
> Transformation( [ 2, 4, 1, 1 ] ),
> Transformation( [ 3, 4, 2, 2 ] ) ];;
...
#T# Factorization for a transformation monoid 1
...
#T# Factorization for a transformation monoid 2
gap> gens:=[ Transformation( [ 1, 3, 2, 3 ] ),
> Transformation( [ 1, 4, 1, 2 ] ),
> Transformation( [ 3, 4, 2, 2 ] ),
...
#T# Factorization for a transformation monoid 3
gap> gens:=[ Transformation( [ 1, 3, 4, 1 ] ),
> Transformation( [ 2, 4, 1, 2 ] ),
> Transformation( [ 3, 1, 1, 3 ] ),
> Transformation( [ 3, 3, 4, 1 ] ) ];;
...
#T# Factorization for a transformation monoid 4
gap> gens:=[ Transformation( [ 1, 3, 2, 3 ] ),
> Transformation( [ 1, 4, 1, 2 ] ),
> Transformation( [ 3, 4, 2, 2 ] ),
> Transformation( [ 4, 1, 2, 1 ] ) ];;
...
#T# Factorization for a partial perm semigroup
...
#T# Factorization for a partial perm inverse semigroup
...
#T# Factorization for a known regular semigroup
gap> s:=OrderEndomorphisms(7);;
gap> ForAll(s, f-> EvaluateWord(GeneratorsOfSemigroup(s),
> Factorization(s,f))=f);
true

#T# Factorization for a semigroup which learns regularity after creation
