...
static StructGVarFunc GVarFuncs[] = {
    ...
    GVAR_ENTRY("semigrp.cc", EN_SEMI_FINAL_LETTER, 2, "S, pos"),
    GVAR_ENTRY("semigrp.cc", EN_SEMI_FIRST_LETTER, 2, "S, pos"),
