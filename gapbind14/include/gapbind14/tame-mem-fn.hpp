...
#include "cpp-fn.hpp" // for CppFunction, GAPBIND14_TRY, T_GAPBIND14_OBJ, arg_count, returns_void
...
template <typename T> class SubTypeSpec;

////////////////////////////////////////////////////////////////////////
// Wilds
////////////////////////////////////////////////////////////////////////

template <typename Wild> auto &all_wild_mem_fns() {
  static std::vector<Wild> fs;
  return fs;
}

template <typename Wild> auto wild_mem_fn(size_t i) {
...
auto tame_mem_fn(Obj self, Obj arg0) -> std::enable_if_t<
    returns_void<Wild>::value && arg_count<Wild>::value == 0, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }

  // TODO(later) figure out how to check that the subtype of arg0 is compatible
  // with Wild
...
template <size_t N, typename Wild, typename TSFINAE = Obj>
auto tame_mem_fn(Obj self, Obj arg0, Obj arg1) -> std::enable_if_t<
    returns_void<Wild>::value && arg_count<Wild>::value == 1, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }
...
template <size_t N, typename Wild, typename TSFINAE = Obj>
auto tame_mem_fn(Obj self, Obj arg0, Obj arg1, Obj arg2) -> std::enable_if_t<
    returns_void<Wild>::value && arg_count<Wild>::value == 2, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }
...
auto tame_mem_fn(Obj self, Obj arg0, Obj arg1, Obj arg2, Obj arg3)
    -> std::enable_if_t<
        returns_void<Wild>::value && arg_count<Wild>::value == 3, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }
  ...
  GAPBIND14_TRY(CppFunction<Wild>()(
      ...
      to_cpp<to_cpp_2_type>()(arg2), to_cpp<to_cpp_3_type>()(arg3)));
  return 0L;
}
...
auto tame_mem_fn(Obj self, Obj arg0, Obj arg1, Obj arg2, Obj arg3, Obj arg4)
    -> std::enable_if_t<
        returns_void<Wild>::value && arg_count<Wild>::value == 4, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }
...
auto tame_mem_fn(Obj self, Obj arg0, Obj arg1, Obj arg2, Obj arg3, Obj arg4,
                 Obj arg5)
    -> std::enable_if_t<
        returns_void<Wild>::value && arg_count<Wild>::value == 5, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }
  ...
  GAPBIND14_TRY(CppFunction<Wild>()(
      wild_mem_fn<Wild>(N), ptr, to_cpp<to_cpp_1_type>()(arg1),
      to_cpp<to_cpp_2_type>()(arg2), to_cpp<to_cpp_3_type>()(arg3),
      to_cpp<to_cpp_4_type>()(arg4), to_cpp<to_cpp_5_type>()(arg5)));
  return 0L;
}
...
auto tame_mem_fn(Obj self, Obj arg0, Obj arg1, Obj arg2, Obj arg3, Obj arg4,
                 Obj arg5, Obj arg6)
    -> std::enable_if_t<
        returns_void<Wild>::value && arg_count<Wild>::value == 6, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }
...
template <size_t N, typename Wild, typename TSFINAE = Obj>
auto tame_mem_fn(Obj self, Obj arg0, Obj arg1, Obj arg2, Obj arg3, Obj arg4,
                 Obj arg5, Obj arg6, Obj arg7)
    -> std::enable_if_t<
        returns_void<Wild>::value && arg_count<Wild>::value == 7, TSFINAE> {
  if (TNUM_OBJ(arg0) != T_GAPBIND14_OBJ) {
    ErrorQuit("expected gapbind14 object but got %s!", (Int)TNAM_OBJ(arg0), 0L);
  }
  ...
  GAPBIND14_TRY(CppFunction<Wild>()(
      ...
      to_cpp<to_cpp_2_type>()(arg2), to_cpp<to_cpp_3_type>()(arg3),
      to_cpp<to_cpp_4_type>()(arg4), to_cpp<to_cpp_5_type>()(arg5),
      to_cpp<to_cpp_6_type>()(arg6), to_cpp<to_cpp_7_type>()(arg7)));
  return 0L;
}
...
struct static_push_back_mem_fns<0, Tame, Wild> {
  void operator()(std::vector<Tame> &v) { std::reverse(v.begin(), v.end()); }
};

template <typename Tame, typename Wild> auto init_tame_mem_fns() {
  std::vector<Tame> fs;
  static_push_back_mem_fns<MAX_FUNCTIONS, Tame, Wild>{}(fs);
  return fs;
}

template <typename Tame, typename Wild> auto &tame_mem_fns() {
  static std::vector<Tame> fs = init_tame_mem_fns<Tame, Wild>();
  return fs;
}

template <typename Tame, typename Wild> auto get_tame_mem_fn(size_t i) {
