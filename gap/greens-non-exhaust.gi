...
"for L-class of a non-exhaustive semigroup and an associative element",
...
InstallMethod(GreensHClassOfElement,
"for R-class of a non-exhaustive semigroup and an associative element",
...
InstallMethod(GreensLClassOfElement, 
"for D-class of non-exhaustive semigroup and associative element",
...
InstallMethod(GreensRClassOfElementNC, 
"for D-class of a non-exhaustive semigroup and associative element",
[IsGreensDClass and IsNonExhaustiveSemigroupGreensClass, IsAssociativeElement],
function(d, f)
  local r;
...
"for a non-exhaustive semigroup and an integer", 
...
InstallMethod(NrRegularDClasses, "for a non-exhaustive semigroup",
[IsNonExhaustiveSemigroup],
function(s)
