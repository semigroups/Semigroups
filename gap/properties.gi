...
function(S)
  ...
  record.treehashsize:=SemigroupOptions(S).hashlen.M;
...
[IsSemigroupWithInverseOp and IsNonExhaustiveSemigroup and HasGeneratorsOfSemigroup], 
function(S)
  local G, iso, enum, f;
...
"for a non-exhaustive semigroup with inverse op", [IsSemigroupWithInverseOp and IsNonExhaustiveSemigroup],
function(S)
  local gens, I, f, i;
