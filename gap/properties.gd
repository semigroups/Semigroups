...
DeclareProperty("IsAmpleSemigroup", IsTransformationSemigroup);
...
DeclareProperty("IsLeftAmpleSemigroup", IsTransformationSemigroup);
...
DeclareProperty("IsRightAbundantSemigroup", IsTransformationSemigroup);
