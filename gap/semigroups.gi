...
#JDM this should be for pperm semigroups only and it should go into semipperm..

InstallOtherMethod(GeneratorsOfSemigroup, 
"for an associative element with semigroup inverse and action collection", 
[IsAssociativeElementWithUniqueSemigroupInverseCollection and IsAssociativeElementWithActionCollection],
function(coll)
  local gens, f;
...
"for associative element with semigroup inverse and action collection", 
[IsAssociativeElementWithUniqueSemigroupInverseCollection and IsAssociativeElementWithActionCollection, IsRecord],
