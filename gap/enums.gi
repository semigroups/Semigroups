...
InstallMethod(EnumeratorOfRClasses, "for a acting semigroup",
[IsActingSemigroup], 
function(s)
  local enum;
...
InstallMethod(Enumerator, "for a D-class of a acting semigroup",
...
InstallMethod(Enumerator, "for a regular D-class of a acting semigroup",
...
InstallMethod(Enumerator, "for L-class of a acting semigroup",
...
InstallMethod(Enumerator, "for R-class of a acting semigroup",
