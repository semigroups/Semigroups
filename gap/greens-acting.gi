...
##      functions Lambda/RhoOrb and Lambda/RhoOrbSCCIndex for the class are set. 
##
...
[IsActingSemigroup], S -> Concatenation(List(GreensDClasses(S), HClassReps)));
