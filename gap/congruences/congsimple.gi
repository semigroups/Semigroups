...
[IsMultiplicativeElementCollection, SEMIGROUPS_CongSimple],
function(pair, cong)
  local S;
    # Input checks
    S := Range(cong);
...
[SEMIGROUPS_CongSimple, IsMultiplicativeElement],
function(cong, elm)
...
[IsMultiplicativeElement, SEMIGROUPS_CongClassSimple],
function(elm, class)
