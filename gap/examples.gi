...
function(func, args, view, print)
  ...
  SetIsClassicalMatrixSemigroup(S, true);
  return S;
end);
...
[IsClassicalMatrixSemigroup and HasGeneratorsOfSemigroup],
...
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(SL, [d, q], "special linear", "SLS");
end);

InstallMethod(GeneralUnitarySemigroup, "for pos int and pos int",
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(GU, [d, q], "general unitary", "GUS");
end);

InstallMethod(SpecialUnitarySemigroup, "for pos int and pos int",
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(SU, [d, q], "special unitary", "SUS");
end);

InstallMethod(SymplecticSemigroup, "for pos int and pos int",
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(Sp, [d, q], "symplectic", "SpS");
end);

InstallMethod(GeneralOrthogonalSemigroup, "for pos int and pos int",
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(GO, [d, q], "general orthogonal", "GOS");
end);
...
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(SO, [d, q], "special orthogonal", "SOS");
end);
...
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(Omega, [d, q], "omega", "OmegaS");
end);
...
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(GammaL, [d, q], "general semilinear", "GammaLS");
end);

InstallMethod(SpecialSemilinearSemigroup, "for pos int and pos int",
[IsPosInt, IsPosInt],
function(d, q)
  return SEMIGROUPS_MatrixSemigroupConstructor(SigmaL, [d, q], "special semilinear", "SigmaLS");
end);
...
#[IsPosInt, IsPosInt],
#function(d, q)
#  return SEMIGROUPS_MatrixSemigroupConstructor(SEMIGROUPS_MatrixGroupConstructor(PGL), [d, q], 
#                                               "projective general linear", "PGLS");
#end);
#
#InstallMethod(ProjectiveSpecialLinearSemigroup, "for pos int and pos int",
#[IsPosInt, IsPosInt],
#function(d, q)
#  return SEMIGROUPS_MatrixSemigroupConstructor(SEMIGROUPS_MatrixGroupConstructor(PSL), [d, q], 
#                                               "projective special linear", "PSLS");
#end);
#
#InstallMethod(ProjectiveGeneralUnitarySemigroup, "for pos int and pos int",
#[IsPosInt, IsPosInt],
#function(d, q)
#  return SEMIGROUPS_MatrixSemigroupConstructor(SEMIGROUPS_MatrixGroupConstructor(PGU), [d, q], 
#                                               "projective general unitary", "PGUS");
#end);
#
#InstallMethod(ProjectiveSpecialUnitarySemigroup, "for pos int and pos int",
#[IsPosInt, IsPosInt],
#function(d, q)
#  return SEMIGROUPS_MatrixSemigroupConstructor(SEMIGROUPS_MatrixGroupConstructor(PSU), [d, q], 
#                                               "projective special unitary", "PSUS");
#end);
#
...
#                                        [d, q], "projective symplectic", "PSPS");
#end);
#InstallMethod(ProjectiveOmegaSemigroup, "for pos int and pos int",
#[IsPosInt, IsPosInt],
#function(d, q)
#  return SEMIGROUPS_MatrixSemigroupConstructor(POmega, [d, q], "projective omega", "POmegaS");
#end);
...
#TODO method for IsFullMatrixSemigroup for a matrix semigroup
